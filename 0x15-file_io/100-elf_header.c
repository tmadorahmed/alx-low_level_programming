 ...
 * @e_ident: that is a pointer to an array containing the ELF magic numbers.
 *
 ...
 * @e_ident: that is a pointer to an array containing the ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
 ...
 * @e_ident: that is a pointer to an array containing the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
 ...
 * @e_ident: that is a pointer to an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @e_entry: that is The address of the ELF entry point.
 * @e_ident: that is a pointer to an array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * @elf: that is The file descriptor of the ELF file.
 *
 ...
 * @argc: that is The number of arguments supplied to the program.
